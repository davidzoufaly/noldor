...
**Spec:** [docs/superpowers/specs/2026-06-10-plan-runner-design.md](../specs/2026-06-10-plan-runner-design.md)
 ...
 * committed spec (`docs/superpowers/specs/*-<slug>-design.md`) and a plan
 * (`docs/superpowers/plans/<date>-<slug>.md`). Eligible FDs are ordered by
