...
gate, I want `/noldor-gate` end-of-flow to auto-stamp the matching bootstrap override
...
**Gate flow (automatic)** — at `/noldor-gate` Step 4, after code-stage review and
