...
- **Tests:**
  - [`scripts/cr/__tests__/amend-receipt.test.ts`](../../scripts/cr/__tests__/amend-receipt.test.ts)
  - [`scripts/cr/__tests__/cli-args.test.ts`](../../scripts/cr/__tests__/cli-args.test.ts)
  - [`scripts/cr/__tests__/codex.test.ts`](../../scripts/cr/__tests__/codex.test.ts)
  - [`scripts/cr/__tests__/context.test.ts`](../../scripts/cr/__tests__/context.test.ts)
  - [`scripts/cr/__tests__/findings-schema.test.ts`](../../scripts/cr/__tests__/findings-schema.test.ts)
  - [`scripts/cr/__tests__/run-codex.test.ts`](../../scripts/cr/__tests__/run-codex.test.ts)
  - [`scripts/cr/__tests__/schema-parity.test.ts`](../../scripts/cr/__tests__/schema-parity.test.ts)
  - [`scripts/cr/__tests__/sidecar.test.ts`](../../scripts/cr/__tests__/sidecar.test.ts)
  - [`scripts/garden/__tests__/garden-detect.test.ts`](../../scripts/garden/__tests__/garden-detect.test.ts)
  - [`scripts/garden/__tests__/garden-receipt.test.ts`](../../scripts/garden/__tests__/garden-receipt.test.ts)
  - [`scripts/garden/detectors/__tests__/allowlist-drift.test.ts`](../../scripts/garden/detectors/__tests__/allowlist-drift.test.ts)
  - [`scripts/garden/detectors/__tests__/codex-cr-override-audit.test.ts`](../../scripts/garden/detectors/__tests__/codex-cr-override-audit.test.ts)
  - [`scripts/garden/detectors/__tests__/fd-without-plan.test.ts`](../../scripts/garden/detectors/__tests__/fd-without-plan.test.ts)
  - [`scripts/garden/detectors/__tests__/override-audit.test.ts`](../../scripts/garden/detectors/__tests__/override-audit.test.ts)
  - [`scripts/garden/detectors/__tests__/plan-without-fd.test.ts`](../../scripts/garden/detectors/__tests__/plan-without-fd.test.ts)
  - [`scripts/garden/detectors/__tests__/tier-mismatch.test.ts`](../../scripts/garden/detectors/__tests__/tier-mismatch.test.ts)
  - [`scripts/garden/detectors/__tests__/trailer-scope-mismatch.test.ts`](../../scripts/garden/detectors/__tests__/trailer-scope-mismatch.test.ts)
  - [`scripts/hooks/__tests__/noldor-validate-trailer.test.ts`](../../scripts/hooks/__tests__/noldor-validate-trailer.test.ts)
  - [`scripts/noldor/__tests__/changelog.test.ts`](../../scripts/noldor/__tests__/changelog.test.ts)
  - [`scripts/noldor/__tests__/lint-plan-snippets.test.ts`](../../scripts/noldor/__tests__/lint-plan-snippets.test.ts)
  - [`scripts/noldor/__tests__/phase-flip-done.test.ts`](../../scripts/noldor/__tests__/phase-flip-done.test.ts)
  - [`scripts/noldor/__tests__/release-markers.test.ts`](../../scripts/noldor/__tests__/release-markers.test.ts)
  - [`scripts/noldor/__tests__/rename-plan-only-tier.test.ts`](../../scripts/noldor/__tests__/rename-plan-only-tier.test.ts)
  - [`scripts/noldor/__tests__/validate-noldor-scope.test.ts`](../../scripts/noldor/__tests__/validate-noldor-scope.test.ts)
  - [`scripts/noldor/__tests__/validate-noldor.test.ts`](../../scripts/noldor/__tests__/validate-noldor.test.ts)
  - [`scripts/noldor/__tests__/validate-skill-catalog.test.ts`](../../scripts/noldor/__tests__/validate-skill-catalog.test.ts)
  - [`scripts/release/__tests__/release-cr-gate-e2e.test.ts`](../../scripts/release/__tests__/release-cr-gate-e2e.test.ts)
  - [`scripts/release/__tests__/release-cr-gate.test.ts`](../../scripts/release/__tests__/release-cr-gate.test.ts)
- **Docs:**
