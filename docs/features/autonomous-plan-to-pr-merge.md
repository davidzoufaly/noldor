...
links:
  ...
  tests:
    - packages/noldor/src/cr/__tests__/in-progress-guard.test.ts
    - packages/noldor/src/cr/__tests__/orchestrate.test.ts
    - packages/noldor/src/cr/__tests__/overwrite-guard.test.ts
    - packages/noldor/src/core/__tests__/pr-flow-cli.test.ts
    - packages/noldor/src/core/__tests__/session.test.ts
