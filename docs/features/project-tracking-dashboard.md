...
links:
  ...
  tests:
    ...
    - packages/noldor/src/dashboard/__tests__/dashboard-doc-surfaces.test.ts
    - >-
      packages/noldor/src/dashboard/__tests__/dashboard-layout-body-styles.test.ts
    - >-
      packages/noldor/src/dashboard/__tests__/dashboard-layout-style-polish.test.ts
    - packages/noldor/src/dashboard/__tests__/dashboard-mermaid.test.ts
    - packages/noldor/src/dashboard/__tests__/dashboard-release-notes.test.ts
    - packages/noldor/src/dashboard/__tests__/dashboard-render-markdown.test.ts
...
- **Tests:**
  ...
  - [`scripts/dashboard/__tests__/dashboard-doc-surfaces.test.ts`](../../scripts/dashboard/__tests__/dashboard-doc-surfaces.test.ts)
  ...
  - [`scripts/dashboard/__tests__/dashboard-layout-style-polish.test.ts`](../../scripts/dashboard/__tests__/dashboard-layout-style-polish.test.ts)
  - [`scripts/dashboard/__tests__/dashboard-mermaid.test.ts`](../../scripts/dashboard/__tests__/dashboard-mermaid.test.ts)
  - [`scripts/dashboard/__tests__/dashboard-release-notes.test.ts`](../../scripts/dashboard/__tests__/dashboard-release-notes.test.ts)
  - [`scripts/dashboard/__tests__/dashboard-render-markdown.test.ts`](../../scripts/dashboard/__tests__/dashboard-render-markdown.test.ts)
