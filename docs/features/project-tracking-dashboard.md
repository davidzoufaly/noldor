...
links:
  ...
  tests:
    ...
    - src/dashboard/__tests__/dashboard-identity.test.ts
    ...
    - src/dashboard/__tests__/dashboard-repo-brand.test.ts
    - src/dashboard/__tests__/dashboard-server.test.ts
    - src/dashboard/__tests__/dashboard-skills.test.ts
    - src/dashboard/__tests__/dashboard-stale-install.test.ts
    - src/dashboard/__tests__/dashboard-status.test.ts
...
- **Tests:**
  ...
  - [`src/dashboard/__tests__/dashboard-identity.test.ts`](../../src/dashboard/__tests__/dashboard-identity.test.ts)
  ...
  - [`src/dashboard/__tests__/dashboard-repo-brand.test.ts`](../../src/dashboard/__tests__/dashboard-repo-brand.test.ts)
  ...
  - [`src/dashboard/__tests__/dashboard-stale-install.test.ts`](../../src/dashboard/__tests__/dashboard-stale-install.test.ts)
  - [`src/dashboard/__tests__/dashboard-status.test.ts`](../../src/dashboard/__tests__/dashboard-status.test.ts)
