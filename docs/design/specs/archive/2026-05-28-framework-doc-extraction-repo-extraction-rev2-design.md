...
- Mappings:
  ...
  - `plan` rows: `docs/design/plans/<file>` → `packages/noldor/docs/design/plans/<file>`
  - `spec` rows: `docs/design/specs/<file>` → `packages/noldor/docs/design/specs/<file>`
...
- Locked monorepo-split spec (now superseded): `docs/design/specs/2026-05-28-framework-doc-extraction-design.md`
- Phase 0 plan (still valid, classifier output reusable): `docs/design/plans/2026-05-28-framework-doc-extraction-phase-0.md`
