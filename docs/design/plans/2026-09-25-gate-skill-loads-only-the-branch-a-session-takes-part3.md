...
- [ ] **Step 2: Save the assembler.** Write `/tmp/gate-assemble.mjs`:
...
- [ ] **Step 3: Assemble the nine files verbatim.**
...
- [ ] **Step 4: Finish each file with its patch.** Apply all nine:
...
- [ ] **Step 5: Mirror the twins and measure.**
