...
// Before (line 198)
const specsDir = join(repo, 'docs/design/specs');
// After
...
- Spec: `docs/design/specs/2026-05-28-framework-doc-extraction-repo-extraction-rev2-design.md`
