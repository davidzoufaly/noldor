 ...
 *
 * Spec: docs/design/specs/2026-05-28-framework-doc-extraction-design.md
 */
 ...
 *   - docs/design/plans/*.md   filename only (classifyPlanOrSpec)
 *   - docs/design/specs/*.md   filename only (classifyPlanOrSpec)
 ...
 *
 * Spec: docs/design/specs/2026-05-28-framework-doc-extraction-design.md § Phase 0.
 */
...
async function main(): Promise<void> {
  ...
  for (const filename of await listMarkdownFilenames('docs/design/plans')) {
  ...
  for (const filename of await listMarkdownFilenames('docs/design/specs')) {
    const track = classifyPlanOrSpec({ filename, featureTracks });
