...
```bash
node bin/noldor.mjs cr orchestrate --slug make-noldor-agent-agnostic --artifact docs/design/specs/2026-07-14-make-noldor-agent-agnostic-runner-parity-followups-design.md --kind spec --autonomous --full-review 2>&1 | tail -5
```
