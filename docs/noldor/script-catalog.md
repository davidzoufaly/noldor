...
- **Trigger:** `pnpm noldor design capture [--surface <name>] [--vouch-only]`. Run instead of a consumer's own capture script — repoint that script at this command (`"design:capture-ui": "noldor design capture"`).
