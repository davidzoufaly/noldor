  ...
  autonomous: {
    ...
    subs: {
      ...
      'branch-state': {
        ...
        desc: "Finish-vs-rebuild verdict for a drain entry's fast/<slug> branch (exit 0 rebuild, 10 finish, 1 stop)",
      },
      status: {
  ...
  design: {
    ...
    subs: {
      ...
      'support-check': {
        ...
        desc: 'Refuse a spec whose ledger records no prior art (exit 2) unless --support "none: <reason>"',
      },
      'geometry-diff': {
  ...
  cr: {
    ...
    subs: {
      ...
      autofix: {
        ...
        desc: 'Decide + record auto-fix rounds for mechanical CR blockers (plan | record)',
      },
      bootstrap: {
