...
## Corpus Check
- Large corpus: 843 files · ~812,278 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2042 nodes · 4997 edges · 131 communities (119 shown, 12 thin omitted)
...
- `main()` --calls--> `removeBlock()`  [INFERRED]
  src/triage/remove-block-cli.ts → src/utils/write-blocks.ts
...
Cohesion: 0.05
Nodes (64): collectRoutingAccuracy(), runWithConcurrency(), loadAreaCategories(), extractTouches(), looksLikePath(), normalizePath(), gitStatusPorcelain(), sizeSkipsSpec() (+56 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (54): isDirty(), loadConfigTolerant(), main(), parseFrom(), runUpgrade(), loadCategories(), loadConsumerConfig(), loadDevConfig() (+46 more)
...
Cohesion: 0.07
Nodes (49): countMatching(), countScriptFiles(), featureSlugsForCodePath(), getDocRoot(), getFeaturesDir(), getNoldorDir(), getReleaseNotesPath(), getScriptsDir() (+41 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (43): walkTokens(), escapeHtml(), handleBacklog(), handleRoadmap(), handleWipAge(), ageBucket(), barTable(), drainStatusLine() (+35 more)
...
Cohesion: 0.1
Nodes (26): loadAgentActivity(), loadDrainObservation(), loadGaps(), loadMetricsReport(), loadVelocity(), loadWatchLogTail(), loadWorktreeHealth(), handle() (+18 more)

### Community 10 - "Community 10"
Cohesion: 0.15
Nodes (28): assertQueueSourceSynced(), assertQueueSourceSyncedAt(), mergedPrExistsFor(), openPrExistsFor(), spawnGate(), syncMainCleanState(), runDrain(), formatReconcile() (+20 more)
...
Cohesion: 0.14
Nodes (21): auditCodexCrOverrides(), detectMigrationCoverage(), evaluateCoverage(), auditOverrides(), detectTierMismatch(), detectAll(), detectContradictions(), detectGateCompliance() (+13 more)
...
Cohesion: 0.19
Nodes (11): loadAgentsConfig(), checkTemplateSync(), main(), resolveChangedFiles(), parseAgents(), installedFrameworkVersion(), filterTemplatesByAgents(), adoptTemplate() (+3 more)

### Community 17 - "Community 17"
Cohesion: 0.15
Nodes (16): checkRedundantDelivery(), ChecksFailedError, ChecksPendingTimeoutError, composeBody(), composeTitle(), GhPreflightError, mergePrWithFallback(), MergeTimeoutError (+8 more)

### Community 18 - "Community 18"
Cohesion: 0.16
Nodes (10): parseOpencodeEvents(), opencodeWantsJson(), planSpawn(), spawnAgent(), spawnClaude(), buildClaudeArgv(), buildCodexArgv(), buildOpencodeArgv() (+2 more)
...
Cohesion: 0.19
Nodes (12): isMicroChoreAllowed(), isReleaseSweepAllowed(), isSessionStale(), getStagedPaths(), logOverride(), runPreCommit(), staleResult(), getReleasePackageFiles() (+4 more)
...
Cohesion: 0.18
Nodes (9): amendSubagentReceipt(), parseArgs(), execAsync(), guardLaneOverwrite(), isEmptyDiffDefault(), resolveLanes(), run(), sinkCandidatePaths() (+1 more)
...
Cohesion: 0.17
Nodes (13): fillAllNoldorMarkers(), fillNoldorMarker(), ensureGhAvailable(), main(), run(), runCheck(), runCliCheck(), runOptionalCheck() (+5 more)
...
Cohesion: 0.15
Nodes (9): diffPhases(), makePhaseTap(), detectStale(), repair(), resolveRoadmapConflict(), appendAgentEvent(), rotateIfNeeded(), row() (+1 more)
...
Cohesion: 0.2
Nodes (9): findEntry(), main(), readFileOrNull(), runSplitCheck(), toResult(), usageError(), assessEntrySplit(), assessFdBreadth() (+1 more)
...
Cohesion: 0.26
Nodes (10): demoteStaleBacklog(), main(), createSlugTracker(), mergeDepFields(), parseBacklog(), parseBlockBody(), parseEntries(), parseRefList() (+2 more)
...
Cohesion: 0.2
Nodes (7): appendToMessage(), detectDroppedTrailers(), formatTrailers(), parseTrailers(), detectAllowlistDrift(), detectTrailerScopeMismatch(), rootCommitShas()

### Community 37 - "Community 37"
Cohesion: 0.27
Nodes (7): clearSession(), readSession(), setAutonomous(), touchSession(), writeSession(), injectTrailers(), withReleaseSession()
...
Cohesion: 0.27
Nodes (11): clearMicroChoreSession(), discoverAddedFiles(), execGit(), loadFdSummary(), loadVerifyEvidence(), nodeSpawn(), normalizeRepoUrl(), parseCrTrailersFromLog() (+3 more)

### Community 44 - "Community 44"
Cohesion: 0.22
Nodes (8): classifyMergeView(), mergePr(), parseWorktrees(), pruneShippedWorktrees(), reapOrphanAgents(), reconcileDeadRun(), reconcileOpenPrs(), reportIsEmpty()
...
Cohesion: 0.22
Nodes (13): getBacklogPath(), getRoadmapPath(), loadBlockedByGraph(), setDocRootsOverride(), handleApiAdd(), handleApiDemote(), handleApiPromote(), handleApiRemove() (+5 more)
...
Cohesion: 0.24
Nodes (5): gateEntry(), isBootstrapReason(), declaredGateKeys(), detectBootstrapOverrideAudit(), gateForTrailer()
...
Cohesion: 0.29
Nodes (9): loadDocRoots(), resolveDesignSubdir(), detectStalePlans(), loadFeatureBySlug(), planSlugFromFilename(), resolveByGraphAdjacency(), resolveByLinksPlan(), resolveByLinksSpec() (+1 more)
...
Cohesion: 0.32
Nodes (8): ensureDashboard(), isDashboardUp(), main(), resolveMainRoot(), sleep(), spawnDetachedServer(), healthUrl(), resolveBindHost()
...
Cohesion: 0.36
Nodes (7): extractArtifactLinks(), fixArtifactLink(), indexSrcByBasename(), main(), migrateOne(), rewriteScriptsPaths(), walk()
...
Cohesion: 0.27
Nodes (5): applyCycleToState(), loadWatchState(), saveWatchState(), readJsonState(), StateFileCorruptError
...
Cohesion: 0.53
Nodes (4): computeSteps(), isNoldorVendoredSkill(), syncFiles(), templatesUnder()
...
- **Why does `loadDocRoots()` connect `Community 59` to `Community 0`, `Community 32`, `Community 66`, `Community 1`, `Community 3`, `Community 72`, `Community 40`, `Community 12`, `Community 13`, `Community 14`, `Community 111`, `Community 51`, `Community 84`, `Community 21`, `Community 52`, `Community 57`, `Community 28`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `loadConsumerConfig()` connect `Community 1` to `Community 0`, `Community 34`, `Community 3`, `Community 4`, `Community 5`, `Community 103`, `Community 8`, `Community 41`, `Community 14`, `Community 48`, `Community 20`, `Community 21`, `Community 24`, `Community 62`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `parseBacklog()` connect `Community 32` to `Community 65`, `Community 3`, `Community 40`, `Community 74`, `Community 12`, `Community 13`, `Community 14`, `Community 84`, `Community 28`, `Community 31`?**
