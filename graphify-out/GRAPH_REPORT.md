...
## Corpus Check
- Large corpus: 1416 files · ~1,773,534 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 4227 nodes · 11247 edges · 239 communities (229 shown, 10 thin omitted)
...
Cohesion: 0.05
Nodes (53): settleWithin(), amendSubagentReceipt(), isNeverBlockingMessage(), isSpecBlockingBasis(), parseCliArgs(), makeCodexSpawn(), codexFailureHint(), describeCodexFailure() (+45 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (66): countMatching(), countScriptFiles(), featureSlugsForCodePath(), getDocRoot(), getFeaturesDir(), getNoldorDir(), getReleaseNotesPath(), getScriptsDir() (+58 more)
...
Cohesion: 0.06
Nodes (37): writeJsonAtomic(), claudeSupportsMaxThinking(), execAsync(), osascriptSpawn(), runStandalone(), templateSha(), openLane(), splitClassTag() (+29 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (51): loadConfig(), resolveDispatchTimeoutMs(), resolveReviewProfile(), codexIsMandatory(), missingMandatoryReviewer(), withMandatoryCodex(), withMandatoryReviewer(), headMatches() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (54): slugKindJsonPath(), arbitrationPath(), digest(), dispose(), disposeBeforeCap(), knownIds(), latestRound(), main() (+46 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (44): collectCrEffectiveness(), collectCycleTime(), percentile(), collectDrainReliability(), collectOverridePressure(), releaseWindow(), collectRoutingAccuracy(), entryToPath() (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (47): escapeHtml(), handleBacklog(), handleRoadmap(), handleWipAge(), ageBucket(), barTable(), drainStatusLine(), formatAgentDuration() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (42): compareSemver(), extractPlanSlug(), isInfraFile(), isLinkEnforced(), detectAdrFindings(), toGaps(), auditOverrides(), auditOverrideTrailers() (+34 more)
...
Cohesion: 0.06
Nodes (25): readValueFlags(), stdoutEmit(), compareGeometry(), extractFamilies(), unmatchedValues(), list(), runGeometryDiff(), parseGeometryDoc() (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (28): laneAnswerDebugPath(), laneAnswerPath(), buildJudgeRepairPrompt(), dropPlaceholders(), isPlaceholderText(), keepRaw(), readLaneAnswer(), unwrapWholeFence() (+20 more)
...
Cohesion: 0.1
Nodes (30): sourceTreeAdapter(), detectLinksDrift(), linksDriftGaps(), doomedCodeLinkWarnings(), buildSlugMap(), classifyFdEnoent(), collectTaggedMany(), diffProjection() (+22 more)
...
Cohesion: 0.07
Nodes (36): loadActiveMilestone(), loadArchitecturePage(), loadArchitecturePages(), loadFrameworkPage(), loadFrameworkPages(), loadUserDoc(), loadUserDocs(), loadWorktreeHealth() (+28 more)
...
Cohesion: 0.13
Nodes (32): isSlug(), slugErrorMessage(), digestBody(), locateForDialogue(), readArtifact(), resolveHeading(), parseContextArgs(), runContext() (+24 more)
...
Cohesion: 0.11
Nodes (27): contained(), inspectLink(), pathErrorMessage(), readFileNoFollowAsync(), readOnlyNoFollowFlags(), slugPath(), aggregate(), main() (+19 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (19): filterCommitsForPage(), listPageSlugs(), loadCommits(), main(), parseScope(), invokedDirectly(), isEntrypoint(), runIfDirect() (+11 more)
...
Cohesion: 0.1
Nodes (13): isDrainEligible(), decideNext(), runDrain(), implementerDispatch(), plansSource(), roadmapSource(), specsSource(), buildDrainGatePrompt() (+5 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (19): resolveErrorMessage(), resolveSlugPath(), git(), originAhead(), createRefusalMessage(), createWorktree(), main(), parseArgs() (+11 more)
...
Cohesion: 0.12
Nodes (19): docProjectionRoots(), readFrontmatter(), isCheckableLinkPath(), collectTargets(), detectFdLinkRot(), collectTestFiles(), extractCodePackages(), main() (+11 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (17): evaluateGardenFreshness(), latestGardenScanCommitTs(), main(), readGardenReceipt(), resolveGardenScanPaths(), writeGardenReceipt(), defaultStamp(), docSurfaceRow() (+9 more)

### Community 33 - "Community 33"
Cohesion: 0.12
Nodes (22): parseReceiptWith(), readReceiptFile(), receiptFilePath(), writeReceiptFile(), runCapture(), surfaceMap(), baselineStamp(), captureSurface() (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (19): fillAllNoldorMarkers(), fillNoldorMarker(), extractLatestReleaseNotes(), resumeRelease(), run(), runCheck(), runCliCheck(), runOptionalCheck() (+11 more)
...
Cohesion: 0.12
Nodes (20): main(), renderReport(), checkArchBaseline(), unreadable(), checkArchDoc(), checkArrows(), checkCoverage(), pairKey() (+12 more)
...
Cohesion: 0.18
Nodes (28): blobIdOfBytes(), blobIdOfWorktreeFile(), milestonePenPath(), specSlugFromFilename(), readRepoText(), approve(), bindingField(), boundFile() (+20 more)
...
Cohesion: 0.16
Nodes (22): isLinkedWorktree(), finishRun(), gh(), git(), main(), preflight(), promoteExitCode(), promoteOne() (+14 more)

### Community 43 - "Community 43"
Cohesion: 0.15
Nodes (15): queuedEntryFindings(), demoteStaleBacklog(), ok(), main(), parseRemoveBlockArgs(), readFlag(), readQueue(), createSlugTracker() (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.12
Nodes (15): detectArchitectureAdvisories(), detectArchitectureFindings(), gapsFrom(), toAdvisoryGaps(), toFindingGaps(), pageFilename(), checkArchitecture(), collectModuleAdvisories() (+7 more)

### Community 45 - "Community 45"
Cohesion: 0.14
Nodes (18): classifyDrainBranch(), closedUnmergedPr(), formatState(), main(), worktreeFor(), parseWorktrees(), checkoutDirtState(), checkoutIsDirty() (+10 more)
...
Cohesion: 0.15
Nodes (22): auditCodexCrOverrides(), detectMilestoneShippedIncomplete(), detectAll(), detectContradictions(), detectGateCompliance(), detectInvariants(), detectSourceDrift(), detectStaleDesignArtifacts() (+14 more)

### Community 48 - "Community 48"
Cohesion: 0.16
Nodes (22): designKindOfPath(), milestoneSlugFromPenPath(), penFileName(), penSlugFromFilename(), errMessage(), expandCandidateValue(), isUiBearing(), matches() (+14 more)

### Community 49 - "Community 49"
Cohesion: 0.15
Nodes (16): appendJsonl(), applyCycleVerdict(), loadPark(), mapCycle(), parkAwareSource(), parkKey(), readInboxRows(), savePark() (+8 more)

### Community 50 - "Community 50"
Cohesion: 0.12
Nodes (13): evaluate(), isBaselinePen(), isFeaturePen(), isPen(), main(), parseRawDiff(), stagedAwarePenLookup(), stagedAwareRecordLookup() (+5 more)
...
Cohesion: 0.13
Nodes (18): renderBlockedBy(), checkLayout(), counterPrefix(), finding(), idFindings(), idOf(), isDigit(), isRecord() (+10 more)
...
Cohesion: 0.13
Nodes (17): buildMilestoneGroups(), getBacklogPath(), getRoadmapPath(), loadBlockedByGraph(), loadMilestoneGroups(), handleApiDemote(), handleApiPromote(), handleApiRemove() (+9 more)
...
Cohesion: 0.16
Nodes (17): formatReconcile(), reportIsEmpty(), formatNotAtRef(), selectionNotAtRef(), selectionReason(), assertConfig(), assertOnlyResolves(), intFlag() (+9 more)

### Community 65 - "Community 65"
Cohesion: 0.15
Nodes (12): projectDrainState(), readState(), writeState(), diffPhases(), makePhaseTap(), collectStatus(), formatStatus(), main() (+4 more)
...
Cohesion: 0.15
Nodes (14): loadLaneMode(), openLaneSink(), cleanupPenScratch(), openDesignReviewRound(), sha256File(), stagePenScratch(), designNotes(), makeTerminalWriter() (+6 more)
...
Cohesion: 0.19
Nodes (17): resolveSessionTtlHours(), findBlocked(), findMilestoneMatch(), formatEntry(), getSuggestions(), getTopPriorityNext(), git(), holdBack() (+9 more)
...
Cohesion: 0.16
Nodes (15): newestMtimeInRoots(), repoRelativePath(), resolvedPathAllowed(), walkDir(), main(), parseArgs(), renderDigest(), renderReport() (+7 more)
...
Cohesion: 0.18
Nodes (9): atomicWriteFileSync(), loadMilestoneGate(), flipPhaseToDone(), revertPhaseForAttach(), readFileNoFollow(), main(), main(), readLedgerFacts() (+1 more)
...
Cohesion: 0.16
Nodes (9): openArtifactForPayload(), filePathFromPayload(), gitToplevel(), isTracked(), runPreEditGuard(), contextFor(), named(), setupRepo() (+1 more)
...
Cohesion: 0.19
Nodes (8): originTaggedScanRoots(), loadConsumerConfig(), loadDevConfig(), loadDevSurfaces(), loadWaivers(), bumpAllPackages(), bumpPackageJson(), main()
...
Cohesion: 0.29
Nodes (15): buildArtifactLink(), buildFileUrlLink(), canonical(), canonicalDir(), classify(), contains(), existingDir(), isTerminalHarness() (+7 more)
...
Cohesion: 0.22
Nodes (6): readQueueFile(), computeVerdict(), resolveAttachMilestone(), buildMergeCandidates(), formatTable(), main()

### Community 108 - "Community 108"
Cohesion: 0.28
Nodes (13): loadDocRoots(), parseSlugList(), requireFlagValue(), discoverPrepEntries(), listFdSlugs(), listSpecFiles(), intArg(), main() (+5 more)
...
Cohesion: 0.27
Nodes (11): isSessionStale(), autoStampOnCleanDetect(), ensureCleanTreeOnMain(), git(), inspectTreeState(), applyFix(), fixGardenReceipt(), fixOriginSync() (+3 more)
...
Cohesion: 0.33
Nodes (7): readCriteria(), extractSection(), fenceDelimiter(), lines(), listHeadings(), stepFence(), trimOuterBlanks()
...
Cohesion: 0.33
Nodes (8): parseSlug(), supportVerdict(), validateSlug(), parseSupportCheckArgs(), runSupportCheck(), slug(), check(), log()
...
Cohesion: 0.36
Nodes (8): autoOpenEnabled(), main(), runOpenArtifact(), isExistingDir(), launchArtifact(), run(), setupRepo(), tempDir()
...
- **Why does `loadDocRoots()` connect `Community 108` to `Community 1`, `Community 136`, `Community 8`, `Community 10`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 25`, `Community 27`, `Community 28`, `Community 40`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 55`, `Community 58`, `Community 63`, `Community 69`, `Community 70`, `Community 72`, `Community 74`, `Community 84`, `Community 85`, `Community 89`, `Community 91`, `Community 101`, `Community 107`, `Community 124`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `isEntrypoint()` connect `Community 23` to `Community 0`, `Community 129`, `Community 2`, `Community 4`, `Community 5`, `Community 133`, `Community 12`, `Community 14`, `Community 17`, `Community 153`, `Community 26`, `Community 34`, `Community 35`, `Community 166`, `Community 167`, `Community 50`, `Community 55`, `Community 61`, `Community 62`, `Community 75`, `Community 82`, `Community 86`, `Community 87`, `Community 88`, `Community 91`, `Community 93`, `Community 107`, `Community 121`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `loadConsumerConfig()` connect `Community 99` to `Community 1`, `Community 7`, `Community 8`, `Community 141`, `Community 13`, `Community 18`, `Community 28`, `Community 158`, `Community 31`, `Community 32`, `Community 34`, `Community 38`, `Community 168`, `Community 71`, `Community 73`, `Community 76`, `Community 78`, `Community 79`, `Community 86`, `Community 91`, `Community 92`, `Community 100`, `Community 109`, `Community 122`?**
