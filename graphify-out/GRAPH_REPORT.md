...
## Corpus Check
- Large corpus: 1423 files · ~1,785,700 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 4264 nodes · 11356 edges · 219 communities (209 shown, 10 thin omitted)
...
8. `detectAll()` - 33 edges
9. `runIfDirect()` - 32 edges
...
## Communities (219 total, 10 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (117): countMatching(), countScriptFiles(), countTestCases(), featureSlugsForCodePath(), getBacklogPath(), getDocRoot(), getFeaturesDir(), getNoldorDir() (+109 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (64): resolveExisting(), featurePath(), flipPhaseToDone(), revertPhaseForAttach(), isSlug(), parseSlug(), slugErrorMessage(), assembleCohort() (+56 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (66): crossSection(), handleDemote(), handleMove(), handlePromote(), handleRemove(), sha256(), collectCrEffectiveness(), collectCycleTime() (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (51): sanitizationIssues(), sanitizeSurfaceName(), screenshotTemplateIssues(), loadLaneMode(), openLaneSink(), cleanupPenScratch(), openDesignReviewRound(), sha256File() (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (50): settleWithin(), amendSubagentReceipt(), parseCliArgs(), makeCodexSpawn(), codexFailureHint(), describeCodexFailure(), formatStderrTail(), probeCodexVersion() (+42 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (61): actualPackageNames(), gitIgnoredPaths(), newestMtimeInRoots(), repoRelativePath(), resolvedPathAllowed(), scanRoots(), walkCodeFiles(), walkDir() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (48): resolveErrorMessage(), resolveSlugPath(), computeVerdict(), resolveAttachMilestone(), git(), originAhead(), createRefusalMessage(), createWorktree() (+40 more)
...
Cohesion: 0.05
Nodes (51): detect(), detectUndeclaredDocImpact(), message(), walkFirstParent(), changedSince(), main(), render(), loadFdOwnership() (+43 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (52): escapeHtml(), faviconHref(), renderLayout(), repoDisplayName(), handleBacklog(), handleRoadmap(), ageBucket(), barTable() (+44 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (48): main(), main(), buildCommandRegistry(), commandTokens(), extractCommandRefs(), isTerminator(), refResolves(), tableBareNames() (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (59): readFileNoFollowAsync(), arbitrationPath(), digest(), dispose(), disposeBeforeCap(), knownIds(), latestRound(), main() (+51 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (43): loadConfig(), resolveDispatchTimeoutMs(), resolveReviewProfile(), codexIsMandatory(), missingMandatoryReviewer(), withMandatoryCodex(), withMandatoryReviewer(), findMarkers() (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (50): listDocMds(), compareSemver(), extractPlanSlug(), extractSpecSlug(), isInfraFile(), isLinkEnforced(), listDirEntsIfExists(), listPlans() (+42 more)
...
Cohesion: 0.08
Nodes (23): writeJsonAtomic(), isNeverBlockingMessage(), isSpecBlockingBasis(), openLane(), splitClassTag(), extractLocations(), applyPriorAnswers(), isLaneFailureBlocker() (+15 more)
...
Cohesion: 0.08
Nodes (26): readQueueFile(), extractSummary(), loadBlockedByGraph(), buildBlockedByGraph(), detectCircularBlockedBy(), findBlockedByCycles(), findCyclesInBuild(), tarjanCycles() (+18 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (35): checkArchBaseline(), unreadable(), checkArchDoc(), checkArrows(), checkCoverage(), arrowEndsOf(), isPenNode(), moduleRefsOf() (+27 more)
...
Cohesion: 0.09
Nodes (20): invokedDirectly(), optionalFlag(), readValueFlags(), runIfDirect(), main(), renderRouteSnippet(), routeEdges(), stdoutEmit() (+12 more)
...
Cohesion: 0.09
Nodes (32): blobIdOfWorktreeFile(), parseReceiptWith(), readReceiptFile(), receiptFilePath(), writeReceiptFile(), baselineStamp(), captureSurface(), declaredSurfaces() (+24 more)
...
Cohesion: 0.12
Nodes (27): contained(), inspectLink(), pathErrorMessage(), readFileNoFollow(), readOnlyNoFollowFlags(), slugKindJsonPath(), slugPath(), aggregate() (+19 more)
...
Cohesion: 0.1
Nodes (22): fillAllNoldorMarkers(), fillNoldorMarker(), extractLatestReleaseNotes(), resumeRelease(), run(), runCheck(), runCliCheck(), runOptionalCheck() (+14 more)
...
Cohesion: 0.13
Nodes (26): loadDocRoots(), detectAll(), detectContradictions(), detectInvariants(), detectSourceDrift(), detectStaleDesignArtifacts(), detectStalePlans(), detectStaleSpecs() (+18 more)
...
Cohesion: 0.1
Nodes (22): fingerprintBlocker(), refutedTrailers(), input(), reRound(), withDecided(), setDispatcher(), input(), reRound() (+14 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (18): atomicWriteFileSync(), buildMilestoneGroups(), loadMilestoneGroups(), handleMilestones(), renderMilestones(), activateMilestone(), buildMilestoneGroupBases(), draftMilestone() (+10 more)

### Community 36 - "Community 36"
Cohesion: 0.13
Nodes (28): expandCandidateValue(), isUiBearing(), matches(), sessionUiVerdict(), surfaceMap(), parseReceiptBytes(), isStaged(), main() (+20 more)
...
Cohesion: 0.15
Nodes (22): assertQueueSourceSynced(), assertQueueSourceSyncedAt(), branchHasUnshippedWorkAt(), mergedPrExistsFor(), mergePr(), openPrExistsFor(), spawnGate(), syncMainCleanState() (+14 more)

### Community 41 - "Community 41"
Cohesion: 0.16
Nodes (20): docPresenceRoots(), docProjectionRoots(), docSlugPath(), milestonePath(), resolveDesignSubdir(), collectTestFiles(), doomedCodeLinkWarnings(), extractCodePackages() (+12 more)
...
Cohesion: 0.17
Nodes (16): sourceTreeAdapter(), classifyFdEnoent(), collectTaggedMany(), diffProjection(), doomedEntries(), loadCachedAll(), project(), reportFailures() (+8 more)

### Community 46 - "Community 46"
Cohesion: 0.2
Nodes (26): blobIdOfBytes(), specSlugFromFilename(), approve(), bindingField(), boundFile(), check(), coverage(), coverageGaps() (+18 more)
...
Cohesion: 0.17
Nodes (19): formatReconcile(), makeReconcileDeps(), reportIsEmpty(), appendJsonl(), applyCycleVerdict(), loadPark(), mapCycle(), parkAwareSource() (+11 more)
...
Cohesion: 0.14
Nodes (9): checkInstallFreshness(), checkOxfmtIgnores(), ignorePatterns(), checkParentOptIn(), isOptInSet(), knownConsumerRoots(), optInKeys(), readConfig() (+1 more)
...
Cohesion: 0.21
Nodes (19): everyPathMatches(), isBookkeepingOnly(), isMicroChoreAllowed(), isNoReviewLaneAllowed(), isReleaseSweepAllowed(), isRetirementOnly(), microChoreOffenders(), pathsOutside() (+11 more)

### Community 63 - "Community 63"
Cohesion: 0.14
Nodes (9): formatInvariantError(), makeInvariants(), runInvariantSafely(), escapeForRegExp(), findDeclaration(), makePublicApiTsdocInvariant(), makeRuleConflictsInvariant(), makeSlugPathChokePointInvariant() (+1 more)
...
Cohesion: 0.15
Nodes (10): keepRaw(), createAnswerSeam(), setLaneSpawn(), takeAnswerFile(), clean(), recording(), buildVerifyPrompt(), buildVerifyRepairPrompt() (+2 more)

### Community 67 - "Community 67"
Cohesion: 0.19
Nodes (14): buildJudgeRepairPrompt(), dropPlaceholders(), isPlaceholderText(), readLaneAnswer(), unwrapWholeFence(), penBridgeRecipe(), answerInstruction(), repairEvidence() (+6 more)

### Community 68 - "Community 68"
Cohesion: 0.16
Nodes (11): pageFilename(), checkArchitecture(), collectFormAdvisories(), collectModuleAdvisories(), fenceKinds(), listModuleDirs(), main(), mentionsModule() (+3 more)
...
Cohesion: 0.18
Nodes (12): appendOverrideLog(), getStagedPaths(), logOverride(), runPreCommit(), staleResult(), awaitPublish(), cliMain(), envTuning() (+4 more)
...
Cohesion: 0.19
Nodes (9): checkRunners(), compareDotted(), referencedRunners(), assertNodeFloor(), checkNodeFloor(), minMajor(), checkBinaryPrerequisites(), checkConsumerScripts() (+1 more)
...
Cohesion: 0.25
Nodes (12): resolveSessionTtlHours(), isSessionStale(), autoStampOnCleanDetect(), ensureCleanTreeOnMain(), git(), inspectTreeState(), applyFix(), fixGardenReceipt() (+4 more)
...
Cohesion: 0.29
Nodes (9): argsAt(), makeLocaleComparePinnedInvariant(), scanSource(), isSanctioned(), rootLiteralIn(), scanSource(), defineSrcScanInvariant(), splitArgs() (+1 more)

### Community 102 - "Community 102"
Cohesion: 0.24
Nodes (6): applyCycleToState(), loadWatchState(), saveWatchState(), readJsonState(), StateFileCorruptError, writeJsonState()
...
Cohesion: 0.23
Nodes (5): isEntrypoint(), collectFiles(), main(), renamePlanOnlyTier(), validateMilestones()
...
Cohesion: 0.31
Nodes (4): main(), renderReport(), node(), writeBaseline()

### Community 129 - "Community 129"
Cohesion: 0.39
Nodes (5): detectArchitectureAdvisories(), detectArchitectureFindings(), gapsFrom(), toAdvisoryGaps(), toFindingGaps()
...
- **Why does `loadDocRoots()` connect `Community 30` to `Community 0`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 14`, `Community 18`, `Community 22`, `Community 28`, `Community 31`, `Community 33`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 56`, `Community 62`, `Community 64`, `Community 68`, `Community 69`, `Community 70`, `Community 73`, `Community 83`, `Community 89`, `Community 95`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `isEntrypoint()` connect `Community 117` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 140`, `Community 17`, `Community 146`, `Community 18`, `Community 21`, `Community 22`, `Community 151`, `Community 152`, `Community 27`, `Community 28`, `Community 159`, `Community 160`, `Community 166`, `Community 55`, `Community 57`, `Community 62`, `Community 65`, `Community 71`, `Community 74`, `Community 84`, `Community 86`, `Community 89`, `Community 106`, `Community 109`, `Community 126`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `loadConsumerConfig()` connect `Community 82` to `Community 0`, `Community 3`, `Community 5`, `Community 9`, `Community 10`, `Community 139`, `Community 14`, `Community 27`, `Community 32`, `Community 41`, `Community 44`, `Community 45`, `Community 53`, `Community 61`, `Community 62`, `Community 84`, `Community 87`, `Community 88`, `Community 90`, `Community 94`?**
